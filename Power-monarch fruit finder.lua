...
local DISCORD_WEBHOOK_URL = "https://discord.com/api/webhooks/1377157913151537212/CONVKX8G_Sq_CwPzkda7IHhhDwh0zCioQBGw0hRnx3LXL4IKElNZpRl7tsFk_6f4MDtE" -- <-- Replace with your webhook URL
...
local function SendDiscordNotification(fruitName)
    ...
    local data = {
        ...
        embeds = {{
            ...
            description = "You just found a fruit: **" .. fruitName .. "**",
            color = 65280, -- green color
            timestamp = os.date("!%Y-%m-%dT%H:%M:%SZ") -- UTC time ISO8601
        }}
    }
...
local function LogFruit(fruitName)
    ...
    SaveFruitLog()
    SendDiscordNotification(fruitName) -- Send webhook on fruit log
end
...
local function CreateUI()
    ...
    Title.Text = "Fruit Finder By Monarch of Curiosity"
    Title.TextColor3 = Color3.fromRGB(255, 255, 255)
    Title.TextSize = 18 -- smaller font size for fitting UI
    ...
    while task.wait() do
        if Config.AutoFruit and not collecting then
            pcall(function()
                ...
                -- Server hop delay increased to 10 seconds
                if not foundFruit and tick() - lastServerHop >= 10 then
